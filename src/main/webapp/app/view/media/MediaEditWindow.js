...
app.view.media.MediaEditWindow = Ext
		.extend(
				Ext.Window,
				{
					title : '编辑广告媒体',
					...
					initComponent : function() {
																		...
																		listeners : {
																			'check' : function(
																				...
																				if (checked) {
																					// 改FieldLabel名
																					document
																							.getElementById('date01').parentNode.parentNode.previousSibling.innerHTML = "选择日期:";
																					field
																							.findParentByType()
																							.findByType(
																									'datefield')[1]
																					...
																					document
																							.getElementById('date01').parentNode.parentNode.previousSibling.innerHTML = "起始日期:";
																				}
																			}
																		}
																	} ]
						...
						app.view.media.MediaEditWindow.superclass.initComponent
					...
					save : function(button) {
						...
						if (deptIds == '') {
							Ext.MessageBox.confirm('提示',
									'您没有选择机构，系统将默认下发给所有广告机', function(btn) {
										if (btn == 'yes') {
											win.saveMedia(button, win, deptIds,
													docIds);
										} else {
							...
							win.saveMedia(button, win, deptIds, docIds);
						}
					},
					upFirst : function() {// 置顶
						var me = this;
					...
					saveTask : function(button, win, deptIds, docIds) {
						var form = win.findByType('form')[0];
						form
								.getForm()
								.submit(
										{
											url : 'cn/wizool/bank/servlet/MediaServlet?method=edit',
											method : 'POST',
											timeout : 300,
											params : {
												docIds : docIds,
