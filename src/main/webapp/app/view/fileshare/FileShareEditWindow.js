...
app.view.fileshare.FileShareEditWindow = Ext.extend(Ext.Window, {
	title : '新增文件',
	width : 600,
	buttonAlign : 'center',
	modal : true,
	...
	initComponent : function() {
		...
		app.view.fileshare.FileShareEditWindow.superclass.initComponent.apply(
				this, arguments);
	},
	...
	save : function(button) {
		...
		wait.show();
		form.getForm().submit({
					url : 'cn/wizool/bank/servlet/DocumentServlet?method=upload',
					method : 'POST',
