...
(function() {
    ...
    var scripts = document.getElementsByTagName('script'),
        localhostTests = [
            ...
            new RegExp("\\b(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\.(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)(:\\d{1,5})?\\b")
        ],
    ...
    for (i = 0, ln = scripts.length; i < ln; i++) {
        ...
        match = scriptSrc.match(new RegExp("bootstrap\\.js$"));
