...
Date.formatCodeToRegex = function(character, currentGroup) {
    ...
    case "M":
        for (var a = [], i = 0; i < 12; ++i){
        	a.push(Date.getShortMonthName(i));
...
Date.prototype.getTimezone = function() {
    ...
    return this.toString().replace(new RegExp("^.* (?:\\((.*)\\)|([A-Z]{1,4})(?:[\\-+][0-9]{4})?(?: -?\\d+)?)$"), "$1$2").replace(new RegExp("[^A-Z]","g"), "");
};
...
Date.prototype.getWeekOfYear = function() {
    ...
    var ms1d = 86400000; // milliseconds in a day
