...
Ext.DomHelper = function(){
    ...
    var emptyTags = new RegExp("^(?:br|frame|hr|img|input|link|meta|range|spacer|wbr|area|param|col)$","i");
    var tableRe = new RegExp("^table|tbody|tr|td$","i");
