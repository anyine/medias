 ...
 */
    ...
    Ext.lib.AnimBase.prototype = {
        ...
        patterns: {
            noNegatives:        new RegExp("width|height|opacity|padding","i"),
            offsetAttribute:  new RegExp("^((width|height)|(top|left))$"),
            defaultUnit:        new RegExp("width|height|top$|bottom$|left$|right$","i"),
            offsetUnit:         new RegExp("\\d+(em|%|en|ex|pt|in|cm|mm|pc)$","i")
        },
    ...
    (function() {
        ...
        proto.patterns.color = new RegExp("color$","i");
        proto.patterns.rgb = new RegExp("^rgb\\(([0-9]+)\\s*,\\s*([0-9]+)\\s*,\\s*([0-9]+)\\)$","i");
        proto.patterns.hex = new RegExp("^#?([0-9A-F]{2})([0-9A-F]{2})([0-9A-F]{2})$","i");
        proto.patterns.hex3 = new RegExp("^#?([0-9A-F]{1})([0-9A-F]{1})([0-9A-F]{1})$","i");
        proto.patterns.transparent = new RegExp("^transparent|rgba\\(0, 0, 0, 0\\)$");
    ...
    (function() {
        ...
        proto.patterns.points = new RegExp("^points$", "i");
