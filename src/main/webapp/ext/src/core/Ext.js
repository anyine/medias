...
(function(){
    ...
    var isStrict = document.compatMode == "CSS1Compat",
        ...
        isSafari = (new RegExp("webkit|khtml")).test(ua),
        ...
        type : function(o){
            ...
            if(t == 'object' && o.nodeName) {
                switch(o.nodeType) {
                    ...
                    case 3: return (new RegExp("\\S")).test(o.nodeValue) ? 'textnode' : 'whitespace';
                }
            }
...
// s now contains the string: '<div class="my-class">Some text</div>'
    ...
    format : function(format){
        ...
        return format.replace(new RegExp("\\{(\\d+)\\}","g"), function(m, i){
            return args[i];
        });
    }
});
